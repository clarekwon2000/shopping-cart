...
Further Explanation with the [gsspread](https://github.com/prof-rossetti/intro-to-python/blob/main/notes/python/packages/gspread.md#downloading-api-credentials) package
